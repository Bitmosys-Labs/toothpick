...
@section('content')
    ...
    <div class="page-content container-fluid">
        <div class="page-header">
            <h1 class="page-title">Add Compliances </h1>
            <ol class="breadcrumb">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <form role="form" action="{{ route('admin.compliances.store') }}"  method="post">
                        <div class="box-body">                
                            <div class="form-group">
                                    ...
                                    <label for="requirement">Requirement</label><input type="text" name="requirement" id="requirement" class="form-control" ></div><div class="form-group">
