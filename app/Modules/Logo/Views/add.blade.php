...
@section('content')
    ...
    <div class="page-content container-fluid">
        <div class="page-header">
            <h1 class="page-title">Add Logos </h1>
            <ol class="breadcrumb">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <form role="form" action="{{ route('admin.logos.store') }}"  method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                    <label for="type">Type</label><input type="file" name="type" id="type" class="form-control" ></div><div class="form-group">
