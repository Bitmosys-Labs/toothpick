                    ...
                    <form role="form" action="{{ route('admin.immunizations.update')}}"  method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                    <label for="staff_id">Staff_id</label><input type="text" value = "{{$immunization->staff_id}}"  name="staff_id" id="staff_id" class="form-control" ></div><div class="form-group">
                                    <label for="requirement">Requirement</label><input type="text" value = "{{$immunization->requirement}}"  name="requirement" id="requirement" class="form-control" ></div><div class="form-group">
