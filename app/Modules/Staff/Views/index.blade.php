...
<div class="page-content container-fluid">
	...
	<div class="page-header">
        ...
        <div class="page-header-actions">
            ...
            <a href="{{ route('admin.staff.create') }}"  class="btn btn-sm btn-primary btn-outline btn-round"  title="create">
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table style="width: 100% !important" id="staff-datatable" class="table table-hover dataTable table-striped">
                    <thead>
                        <tr>
                            <th>SN</th>
							<th >Type</th>
...
<script>
    ...
    $(function(){
        dataTable = $('#staff-datatable').DataTable({
        dom: 'Bfrtip',
        "serverSide": true,
        buttons: [
        'copy', 'csv', 'excel', 'pdf', 'print'
        ],
        'ajax' : { url: "{{ route('admin.staff.getdatajson') }}",type: 'POST', data: {'_token': '{{ csrf_token() }}' } },

            columns: [
                { data: function (data, type, row, meta) {
                    return meta.row + meta.settings._iDisplayStart + 1;
                },name: "sn", searchable: false },
                { data: "type",name: "type"},{ data: "deleted_at",name: "deleted_at"},{ data: "created_at",name: "created_at"},{ data: "updated_at",name: "updated_at"},
