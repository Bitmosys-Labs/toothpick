...
@section('content')
    ...
    <div class="page-content container-fluid">
        <div class="page-header">
            <h1 class="page-title">Add Booking_statuses </h1>
            <ol class="breadcrumb">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <form role="form" action="{{ route('admin.booking_statuses.store') }}"  method="post">
                        <div class="box-body">                
                            <div class="form-group">
                                    ...
                                    <label for="canceled_by">Canceled_by</label><input type="text" name="canceled_by" id="canceled_by" class="form-control" ></div><div class="form-group">
                                    <label for="reason_for_cancel">Reason_for_cancel</label><input type="text" name="reason_for_cancel" id="reason_for_cancel" class="form-control" ></div><div class="form-group">
                                    <label for="cancel_date">Cancel_date</label><input type="text" name="cancel_date" id="cancel_date" class="form-control" ></div><div class="form-group">
