    ...
    $(function(){
        ...
        'ajax' : { url: "{{ route('admin.bank_details.getdatajson') }}",type: 'POST', data: {'_token': '{{ csrf_token() }}' } },
            ...
            columns: [
                ...
                { data: "user_id",name: "user_id"},{ data: "bank_name",name: "bank_name"},{ data: "acc_no",name: "acc_no"},{ data: "status",name: "status"},{ data: "deleted_at",name: "deleted_at"},{ data: "created_at",name: "created_at"},{ data: "updated_at",name: "updated_at"},
