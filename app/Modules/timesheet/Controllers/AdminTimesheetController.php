...
class AdminTimesheetController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("Timesheet::index",compact('page'));
    ...
    public function gettimesheetsJson(Request $request)
    {
        ...
        // For pagination
        $filterTotal = $timesheet->where( function($query) use ($where) {
            if($where !== null) {
        ...
        $rows = $timesheet->where( function($query) use ($where) {
            if($where !== null) {
                foreach($where as $val) {
                    $query->orWhere($val[0],$val[1],$val[2]);
                }
    ...
    public function create()
    {
        ...
        return view("Timesheet::add",compact('page'));
        //
    }
    ...
    public function edit($id)
    {
        ...
        $page['title'] = 'Timesheet | Update';
        return view("Timesheet::edit",compact('page','timesheet'));
