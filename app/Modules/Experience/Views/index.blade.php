...
<div class="page-content container-fluid">
	...
	<div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">Experiences</a></li>
        </ol>
        <div class="page-header-actions">

            <a href="{{ route('admin.experiences.create') }}"  class="btn btn-sm btn-primary btn-outline btn-round"  title="create">
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table style="width: 100% !important" id="experience-datatable" class="table table-hover dataTable table-striped">
                    <thead>
                        <tr>
                            <th>SN</th>
                            <th >Type</th>
...
<script>
    ...
    $(function(){
        dataTable = $('#experience-datatable').DataTable({
        dom: 'Bfrtip',
        "serverSide": true,
        buttons: [
        'copy', 'csv', 'excel', 'pdf', 'print'
        ],
        'ajax' : { url: "{{ route('admin.experiences.getdatajson') }}",type: 'POST', data: {'_token': '{{ csrf_token() }}' } },
