                            ...
                            <div class="form-group">
                                    <label for="comp_id">Compliance</label>
                                        <select  name="comp_id" id="comp_id" class="form-control" required>
                                            <option value="" disabled selected>Select A Compliance</option>
                                            @foreach($compliances as $compliance)
                                                <option value="{{$compliance->type}}">{{$compliance->type}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <label for="picture">Picture</label><input type="file" name="picture" id="picture" class="form-control" required>
                                    </div><div class="form-group">
