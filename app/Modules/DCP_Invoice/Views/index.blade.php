...
<div class="page-content container-fluid">
	...
	<div class="page-header">
        <h1 class="page-title">DCP Invoice</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="breadcrumb-item active"><a href="#">DCP Invoice</a></li>
        </ol>
        ...
        dataTable = $('#dcp-datatable').DataTable({
            ...
            columns: [
                ...
                { data: function(data,b,c,table) {
                        ...
                        buttons += "<a class='btn btn-sm btn-success btn-outline'  title='Details' href='"+site_url+"/edit/"+data.id+"'><i class='fa fa-list' aria-hidden='true'></i></a>&nbsp;&nbsp";
