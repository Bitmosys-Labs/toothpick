    ...
    public function profile(){
        if (auth()->check()) {
            $data = Practice::join('users', 'users.id', 'practice.user_id')
                ...
                ->select('users.name', 'users.contact', 'users.picture', 'practice.owners_name', 'practice.pay_rate', 'practice.postcode', 'practice.address', 'practice.gdc_no', 'practice.emergency_contact')
                ->first();
            $response = [
                'success' => true,
